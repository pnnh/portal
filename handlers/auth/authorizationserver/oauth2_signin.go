...
func OAuth2SigninEndpoint(gctx *gin.Context) {
	...
	// 	gctx.JSON(http.StatusOK, nemodels.NECodeError.WithMessage("用户名或密码为空"))
	// 	return
	// }
	...
	// if err != nil {
	// 	gctx.JSON(http.StatusOK, nemodels.NECodeError.WithMessage("生成token失败"))
	// 	return
	// }
	...
	// 		gctx.JSON(http.StatusOK, nemodels.NECodeError.WithMessage("WEB_URL未配置"))
	// 		return
	// 	}
	...
	// if err != nil {
	// 	gctx.JSON(http.StatusOK, nemodels.NECodeError.WithMessage("authInfo解析失败"))
	// 	return
	// }
	// redirectUrl := string(authBytes)
	// if len(redirectUrl) < 1 {
	// 	gctx.JSON(http.StatusOK, nemodels.NECodeError.WithMessage("redirectUrl为空"))
	// 	return
	// }
